...
DB_MAPPING = {
    ...
    "db_meteorologia":[
        ...
        'tb_indices_itcz_observado',
        'tb_chuva_observada_cpc_climatologia',
    ]
...
class db_mysql_master():
    ...
    def getSchema(self, table_name:str) -> db.Table:
        ...
        elif table_name.lower() == 'tb_chuva_observada_cpc_climatologia':

            table_schema = db.Table('tb_chuva_observada_cpc_climatologia', self.meta,
                db.Column('dt_observada', db.Date, nullable=True),
                db.Column('vl_chuva', db.Float, nullable=True),
                db.Column('cd_subbacia', db.Integer, nullable=True),
            )
...
if __name__ == '__main__':
    ...
    # database.create_table('newave_previsoes_cargas')
    ...
    # database.create_table('tb_indices_itcz_observado')  
    # database.create_table('tb_chuva_observada_cpc_climatologia')  
