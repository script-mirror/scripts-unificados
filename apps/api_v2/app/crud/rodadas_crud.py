...
class Chuva:
    ...
    def export_rain(id_rain: int) -> dict:
        ...
        res = r.post('https://tradingenergiarz.com/backend/api/map', verify=False, json=body, headers={'Content-Type': 'application/json', 'Authorization': 'Bearer eyJraWQiOiJnbHlJWXFDck5tT3JQSFkyOHNHZGxJUVpkUExHUlFMMnBXbWJ6eDA3VEdFPSIsImFsZyI6IlJTMjU2In0..bWx9MmAK_-arU6jeKW696ArnYkzLkiE3-K3lDP6fAboYM9UR022jw9qcAqTqqAyzhsGqLjLBvqvuTEAbCPv5eA9jQNm6lI1lt7AumNhf5Nvr4PyUi51lBCb0e84qH0Wo6q_pahF0nMKrRRBUFdGz9fwby7fwQFCbSKRMBVXGciwWmzVI9nBCxF4rWPtRkfbVRhItaSlfRmgZjuAudZfzKoJAJPQ3Ld1A6Fez7tBZ2FBd2D6b15rvwR3wP_PuSGA02qs5Uo57CZ3gmpd8MtzYz1jpQLqa4srH0O0GYe4Ysoho9Xx20PnOjxDZ47BM2odtC4mzHkabWJPy2LmfcOuCWA'})
        try:
