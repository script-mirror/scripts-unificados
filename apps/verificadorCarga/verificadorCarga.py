...
# 	STR_SUBMERCADO varchar(10) NOT NULL,
# 	DT_REFERENTE datetime NOT NULL,
# 	VL_CARGA float DEFAULT NULL NULL,
# 	DT_UPDATE datetime DEFAULT NULL,
# 	FL_EXCLUIR bit NULL
# );


# CREATE TABLE TB_GERACAO_HORARIA (
# 	STR_SUBMERCADO varchar(10) NOT NULL,
# 	DT_REFERENTE datetime NOT NULL,
# 	VL_CARGA float DEFAULT NULL NULL,
# 	CD_GERACAO int NOT NULL,
