...
var bacia_aux = {'GRANDE':'GRANDE', 'PARANAÍBA':'PARANAÍBA', 'ALTO TIETÊ':'ALTO TIETÊ', 'TIETÊ':'TIETÊ', 'XINGU':'XINGU' ,'PARANAPANEMA':'PARANAPANEMA',  'ALTO PARANÁ':'ALTO PARANÁ', 'BAIXO PARANÁ':'BAIXO PARANÁ', 'INCREMENTAL DE ITAIPU':'INCREMENTAL DE ITAIPU', 'SÃO FRANCISCO (SE)':'SÃO FRANCISCO (SUDESTE)', 'TOCANTINS (SE)':'TOCANTINS (SUDESTE)', 'AMAZONAS (SE)':'MADEIRA', 'IGUAÇU':'IGUAÇU', 'URUGUAI':'URUGUAI', 'PARANAPANEMA (S)':'PARANAPANEMA (SUL)', 'JACUÍ':'JACUÍ', 'CAPIVARI':'CAPIVARI', 'ITAJAÍ-AÇU':'ITAJAÍ-AÇU', 'SÃO FRANCISCO (NE)':'SÃO FRANCISCO (NORDESTE)', 'TOCANTINS (N)':'TOCANTINS (NORTE)'}
